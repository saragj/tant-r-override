...
| **Design system** | `presentation/web/design-systems.md` | - | - |
| **UI standards** | `presentation/web/ui-styling-standards.md` | - | - |
| **Animation patterns** | `presentation/web/animation-patterns.md` | - | - |
...
- **Design Systems**: `.opencode/context/presentation/web/design-systems.md`
- **UI Styling Standards**: `.opencode/context/presentation/web/ui-styling-standards.md`
- **Animation Patterns**: `.opencode/context/presentation/web/animation-basics.md`, `.opencode/context/presentation/web/animation-advanced.md`
