<!-- Context: presentation/navigation | Priority: critical | Version: 1.0 | Updated: 2026-02-15 -->
...
- `presentation/web/` - Core web UI patterns (parent directory)
- `presentation/web/animation-patterns.md` - CSS animations and transitions
